...
('123e4567-e89b-12d3-a456-426614174000', 'CELULAR', '+55(11)99999-9999', 'CORRENTE', '1230', '56789012', 'José', 'Santos', '2021-02-01', '2021-12-01', 'FISICA');
INSERT INTO chaves_pix (id, tipo_chave, valor_chave, tipo_conta, numero_agencia, numero_conta, nome_correntista, sobrenome_correntista, data_inclusao, data_inativacao, tipo_pessoa) VALUES
...
INSERT INTO chaves_pix (id, tipo_chave, valor_chave, tipo_conta, numero_agencia, numero_conta, nome_correntista, sobrenome_correntista, data_inclusao, data_inativacao, tipo_pessoa) VALUES
('123e4567-e89b-12d3-a456-426614174003', 'CNPJ', '54359687000185', 'CORRENTE', '4567', '89000000', 'Pedro Augusto', null, '2021-01-01', null, 'JURIDICA');
INSERT INTO chaves_pix (id, tipo_chave, valor_chave, tipo_conta, numero_agencia, numero_conta, nome_correntista, sobrenome_correntista, data_inclusao, data_inativacao, tipo_pessoa) VALUES
...
INSERT INTO chaves_pix (id, tipo_chave, valor_chave, tipo_conta, numero_agencia, numero_conta, nome_correntista, sobrenome_correntista, data_inclusao, data_inativacao, tipo_pessoa) VALUES
('123e4567-e89b-12d3-a456-426614174005', 'ALEATORIO', '987ss5432109877', 'CORRENTE', '4567', '89012345', 'João', 'da Silva', '2021-02-01', '2021-01-01', 'JURIDICA');
INSERT INTO chaves_pix (id, tipo_chave, valor_chave, tipo_conta, numero_agencia, numero_conta, nome_correntista, sobrenome_correntista, data_inclusao, data_inativacao, tipo_pessoa) VALUES
('123e4567-e89b-12d3-a456-426614174006', 'ALEATORIO', '987ss5432h09877', 'CORRENTE', '4567', '89012345', 'João', 'da Silva', '2021-02-01', null, 'JURIDICA');
INSERT INTO chaves_pix (id, tipo_chave, valor_chave, tipo_conta, numero_agencia, numero_conta, nome_correntista, sobrenome_correntista, data_inclusao, data_inativacao, tipo_pessoa) VALUES
...
INSERT INTO chaves_pix (id, tipo_chave, valor_chave, tipo_conta, numero_agencia, numero_conta, nome_correntista, sobrenome_correntista, data_inclusao, data_inativacao, tipo_pessoa) VALUES
('123e4567-e89b-12d3-a456-426614174010', 'EMAIL', 'maria.silva@gmail.com', 'POUPANCA', '1234', '56789012', 'Maria', 'Silva', '2021-02-01', null, 'FISICA');
INSERT INTO chaves_pix (id, tipo_chave, valor_chave, tipo_conta, numero_agencia, numero_conta, nome_correntista, sobrenome_correntista, data_inclusao, data_inativacao, tipo_pessoa) VALUES
('123e4567-e89b-12d3-a456-426614174011', 'EMAIL', 'pedro.augusto@gmail.com', 'POUPANCA', '4567', '89000000', 'Pedro Augusto', null, '2021-01-01', '2021-12-31', 'JURIDICA');